...
all_projects_df = pd.read_csv("all_projects_top_39_3.csv")
...
for id in id_project_list:
    try:
        ...
        print('General', price_last_week[0]['created_at'], year, week, id, project_name,
...
pd.DataFrame(data).to_csv('top_30_performances_39_3.csv', sep=',', index=False)